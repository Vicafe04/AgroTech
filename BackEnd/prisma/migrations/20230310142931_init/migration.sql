...
-- AddForeignKey
ALTER TABLE `Motoristas` ADD CONSTRAINT `Motoristas_servicoId_fkey` FOREIGN KEY (`servicoId`) REFERENCES `Servicos`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `Manutencao` ADD CONSTRAINT `Manutencao_frotaId_fkey` FOREIGN KEY (`frotaId`) REFERENCES `Frotas`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
